<div class="left side-menu">
    ...
    <div class="left-side-logo d-block d-lg-none">
        <div class="text-center">
            ...
            <a href="index.html" class="logo"><img src="{{ asset('images/logo-dark.png') }}" height="20" alt="logo"></a>
        </div>
    </div>
            ...
            <ul>
                ...
                <li>
                    <a href="index.html" class="waves-effect">
                        ...
                        <span> Dashboard <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></span>
                    </a>
                </li>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-document"></i><span> Forms </span> <span class="badge badge-info badge-pill float-right">15</span></a>
                    <ul class="list-unstyled">
